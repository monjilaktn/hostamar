...
export default function ReferralPage() {
  ...
  const nextTier = referralData.referralRewards.find(r => referralData.referredCount < r.threshold)
  const currentTier = [...referralData.referralRewards].reverse().find(r => referralData.referredCount >= r.threshold)
